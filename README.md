Este repositório contém uma coleção de pequenos projetos desenvolvidos em Python. Eles foram criados com o objetivo de praticar lógica de programação, uso de bibliotecas e automações simples.
